...
public class CustomCatBreedRepositoryImpl implements CustomCatBreedRepository {
    ...
    public List<CatBreed> CustomCatBreedMethod(Map<String, Object> param) {
        ...
        if (param.containsKey("averageLifespanFrom")){
            query.addCriteria(Criteria.where("averageLifespan").gte(Integer.parseInt(param.get("averageLifespanFrom").toString())));
        }
        ...
        if (param.containsKey("lengthTo")){
            query.addCriteria(Criteria.where("length.from").is(Integer.parseInt(param.get("lengthTo").toString())));
        }
        ...
        if (param.containsKey("gentlenessFrom")){
            query.addCriteria(Criteria.where("characteristics.gentleness").gte(Integer.parseInt(param.get("gentlenessFrom").toString())));
        }
        if (param.containsKey("immunityTo")){
            query.addCriteria(Criteria.where("characteristics.gentleness").lte(Integer.parseInt(param.get("immunityTo").toString())));
        }
        if (param.containsKey("immunityFrom")){
            query.addCriteria(Criteria.where("characteristics.gentleness").gte(Integer.parseInt(param.get("immunityFrom").toString())));
        }
        ...
        if (param.containsKey("playfulnessFrom")){
            query.addCriteria(Criteria.where("characteristics.playfulness").gte(Integer.parseInt(param.get("playfulnessFrom").toString())));
        }
        ...
        if (param.containsKey("moltFrom")){
            query.addCriteria(Criteria.where("characteristics.molt").gte(Integer.parseInt(param.get("moltFrom").toString())));
        }
        ...
        if (param.containsKey("careFrom")){
            query.addCriteria(Criteria.where("characteristics.care").gte(Integer.parseInt(param.get("careFrom").toString())));
        }
        ...
        if (param.containsKey("intelligenceFrom")){
            query.addCriteria(Criteria.where("characteristics.intelligence").gte(Integer.parseInt(param.get("intelligenceFrom").toString())));
        }
        ...
        if (param.containsKey("childFriendslinessFrom")){
            query.addCriteria(Criteria.where("characteristics.childFriendsliness").gte(Integer.parseInt(param.get("childFriendslinessFrom").toString())));
        }
        ...
        if (param.containsKey("petFriendlinessFrom")){
            query.addCriteria(Criteria.where("characteristics.petFriendliness").gte(Integer.parseInt(param.get("petFriendlinessFrom").toString())));
        }
